...
export default {
  ...
  data () {
    return {
      description: 'Découvrez les avantages thérapeutiques de la molécule de CBD (cannabidiol) pour le corps humain.',
      title: 'CBD'
    }
  },
  mounted () {
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'og:image', property: 'og:image', content: '/cbd/cbdmeta.jpg' },
